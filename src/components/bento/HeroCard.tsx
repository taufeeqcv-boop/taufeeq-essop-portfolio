...
import { Mail, Linkedin, FileText, User } from "lucide-react";
...
export default function HeroCard() {
  return (
    <motion.div
      ...
      className="h-full min-h-0 flex flex-col justify-between rounded-3xl border border-[length:1px] border-[#27272a] bg-[#18181b] p-6 md:p-8 transition-all duration-300 hover:border-zinc-600 hover:-translate-y-1 hover:shadow-xl hover:shadow-black/30"
    >
      <div>
